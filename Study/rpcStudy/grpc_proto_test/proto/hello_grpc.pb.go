...
const (
	SayHello_SayHello_FullMethodName = "/proto.sayHello/SayHello"
	SayHello_Ping_FullMethodName     = "/proto.sayHello/Ping"
)
...
func (c *sayHelloClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
...
func (c *sayHelloClient) Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Pong, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Pong)
...
func (UnimplementedSayHelloServer) SayHello(context.Context, *HelloRequest) (*HelloReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHello not implemented")
}
func (UnimplementedSayHelloServer) Ping(context.Context, *Empty) (*Pong, error) {
...
func _SayHello_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayHelloServer).Ping(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
