...
func (c *sayHelloClient) SayHello(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error) {
...
func (UnimplementedSayHelloServer) SayHello(context.Context, *User) (*User, error) {
